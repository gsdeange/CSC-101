      ...
      if(choice == 's' or choice == 'S'):
         ...
         quakeFuncs.print_table(earthquakes)
          ...
          if(filter == 'm' or filter == 'M'):
             ...
             filterquakes = quakeFuncs.filter_by_mag(earthquakes, lowerbound, upperbound)
             print()
             quakeFuncs.print_table(filterquakes)
          elif(filter == 'p' or filter == 'P'):
             search = input("Search for what string? ")
             filterquakes = quakeFuncs.filter_by_place(earthquakes, search)
             print()
             quakeFuncs.print_table(filterquakes)
